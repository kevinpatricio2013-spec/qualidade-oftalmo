  ...
  async function salvarTriagem() {
    ...
    try {
      ...
      const payload = {
        ...
        triado_por_qualidade_id:
          selecionada.triado_por_qualidade_id || null,
      ...
      setErro(error.message || "Erro ao salvar triagem.");
    } finally {
      setSaving(false);
    }
  }
            ...
            {!selecionada ? (
              ...
              <>
                ...
                <section className="grid gap-6 xl:grid-cols-2">
                  <Bloco titulo="Análise de causa raiz">
                    <div className="grid gap-4">
                      <CampoTextarea
                  ...
                  <Bloco titulo="Protocolo de Londres">
                    <div className="grid gap-4">
                      <CampoTextarea
                ...
                <section className="grid gap-6 xl:grid-cols-2">
                  ...
                  <Bloco titulo="Força da intervenção">
                    <div className="grid gap-4">
                      <CampoTextarea
                ...
                <Bloco titulo="Plano de ação 5W3H">
